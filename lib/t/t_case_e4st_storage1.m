function [mpc, roffer, contab] = t_case_e4st_storage1
...
% There are two days, both with two hours. For day 1, the first hour has a
% load of 15 MW, while the second has a load of 25 MW. Day two is the same
% but the hours are reversed. This is the most basic test of e4st storage.
...
mpc.gen = [
	...
	% battery
	2	10	0	0	0	1	100	1	11	-11	0	0	0	0	0	0	0	Inf	0	0	0;
	% dispatchable loads
...
contab = [
    ...
    2   0.25    CT_TAREALOAD    2   CT_LOAD_ALL_P   CT_REL  0.8;
